...
class _AgeLocState extends State<AgeLoc> {
  ...
  Future<void> initUniqueIdentifierState1() async{
    await initUniqueIdentifierState1();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: onRecieved
